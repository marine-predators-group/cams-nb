...
snap02_est_gff=${wd}/snap02/20190108_geoduck_snap01.maker.all.noseqs.est2genome.gff
snap02_gff=${wd}/snap02/20190108_geoduck_snap02.all.gff
snap02_gff_renamed=${wd}/snap02/20190108_geoduck_snap02.all.renamed.gff
snap02_protein_gff=${wd}/snap02/20190108_geoduck_snap01.maker.all.noseqs.protein2genome.gff
snap02_rm_gff=${wd}/snap02/20190108_geoduck_snap01.maker.all.noseqs.repeats.gff
