...
I ran PCR reactions on a subset (Sample #: 2, 3, & 4) of the 10 samples that [I performed adaptor ligations on Friday](https://robertslab.github.io/sams-notebook/2015-10-09-adaptor-ligation-oly-alfi-digested-gdna-for-rad-seq-2.html).
