...
Before we check out this month’s goals, let’s have a quick review of [last month’s goals](2015/06/01/goals-june-2015.html) and which, if any, I was able to accomplish:
...
Little progress. No response from Univ. of Oregon. However, it seems that [Mac has been having a similar issue with libraries constructed using Epigentek kits](httpss://github.com/sr320/LabDocs/issues/117). She has contacted Illumina and Epigentek for help.
