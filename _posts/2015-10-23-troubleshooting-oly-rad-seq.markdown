...
[After the failure of the prep-scale PCR for the RAD library construction](2015/10/13/pcr-oly-rad-seq-prep-scale-pcr.html), Katherin Silliman pointed out [a potential problem (too much dNTPs)](http://onsnetwork.org/kubu4/2015/10/13/pcr-oly-rad-seq-prep-scale-pcr/#comments). This was odd because I was following the Meyer Protocol and I used what was indicated.
