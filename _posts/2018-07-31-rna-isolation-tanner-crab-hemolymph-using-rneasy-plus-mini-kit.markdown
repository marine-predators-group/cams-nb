...
Tanner crab RNA has proved [a bit troublesome](https://robertslab.github.io/sams-notebook/2018/07/19/rna-cleanup-tanner-crab-rna-pools.html). As such, [Steven asked me to try isolating some RNA using the RNeasy Plus Mini Kit (Qiagen)(https://github.com/RobertsLab/resources/issues/327) to see how things would turn out.
