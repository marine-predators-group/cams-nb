...
Then, [aligned the assembled transcriptome to our genome using Bowtie2](https://robertslab.github.io/sams-notebook/2018-09-19-transcriptome-alignment-olympia-oyster-trinity-transcriptome-aligned-to-genome-with-bowtie2.html).
