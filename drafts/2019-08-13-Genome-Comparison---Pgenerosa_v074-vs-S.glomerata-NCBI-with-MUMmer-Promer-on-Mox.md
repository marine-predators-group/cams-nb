...
- [20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi.sh](https://github.com/RobertsLab/sams-notebook/blob/master/sbatch_scripts/20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi.sh)

```shell
#!/bin/bash
## Job Name
#SBATCH --job-name=promer_pgen074_vs_sglo-ncbi
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi
...
![pgen-v074 vs sglo-ncbi MUMmer promer runtime screencap](https://github.com/RobertsLab/sams-notebook/blob/master/images/screencaps/20190813_mummer_promer_pgen-074_sglo-ncbi_runtime.png?raw=true)

Output folder:

- [20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi/](https://gannet.fish.washington.edu/Atumefaciens/20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi/)

MUMmer delta file (text):

- [20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi/pgen-v074_sglo-ncbi.delta](https://gannet.fish.washington.edu/Atumefaciens/20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi/pgen-v074_sglo-ncbi.delta)
...
- [20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi/pgen-v074_sglo-ncbi.coords.txt](https://gannet.fish.washington.edu/Atumefaciens/20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi/pgen-v074_sglo-ncbi.coords.txt)

MUMmer PGA_scaffold1 coordinates file (text):

- [20190807_pgen_mummer_pgen-v074_sglo-ncbi/PGA_scaffold1.coords.txt](https://gannet.fish.washington.edu/Atumefaciens/20190813_pgen_mummer_promer_pgen-v074_sglo-ncbi/PGA_scaffold1.coords.txt)
