...
If each sample is going to generate a 178GB (or larger?) file, I'll need to run this analysis directly on Gannet, as my computer's HDD won't have enough space...
