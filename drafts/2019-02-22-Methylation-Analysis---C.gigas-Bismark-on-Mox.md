...
categories:
  - Miscellaneous
---
This is a quick and dirty (i.e. no adaptor/quality trimming) assessment of all of our _Crassostrea gigas_ bisulfite sequencing efforts to date in order to get a rough idea of the methylation mapping, per [this GitHub issue](https://github.com/RobertsLab/resources/issues/589). Ran Bismark on Mox on a series of subset of the reads:
...
- [20190222_cgigas_se_bismark/](http://gannet.fish.washington.edu/Atumefaciens/20190222_cgigas_se_bismark/)
...
- There is a bedgraph for each single-end subset. I will not link them all. Here's an example for the 10,000,000 subset:
  - [20190222_cgigas_se_bismark/subset_10000000/cgig_bsseq_all_R1_bismark_bt2.deduplicated.bedGraph.gz](http://gannet.fish.washington.edu/Atumefaciens/20190222_cgigas_se_bismark/subset_10000000/cgig_bsseq_all_R1_bismark_bt2.deduplicated.bedGraph.gz)
